...
const CONTENT = {
  fr: {
    ...
    dek:       "Développement logiciel sur mesure basé à Alger. Alternative nearshore aux prestataires européens — mêmes standards, plus de puissance d'ingénierie par budget. Logiciel, IA, mobile, cloud, IoT, cybersécurité — huit disciplines, de la startup au groupe industriel.",
  ...
  en: {
    ...
    dek:       'Software development company headquartered in Algiers. Nearshore alternative to European agencies — same standards, more engineering power per budget. Custom software, AI, mobile apps, cloud, IoT, cybersecurity — eight disciplines, from startups to enterprises.',
    ctaWhatsapp: 'WhatsApp',
  ...
  ar: {
    ...
    line3:     'للإنتاج.',
    dek:       'شركة تطوير برمجيات مقرها الجزائر العاصمة. بديل نيرشور للوكالات الأوروبية — نفس المعايير، قوة هندسية أكبر لكل ميزانية. برمجيات مخصصة، ذكاء اصطناعي، تطبيقات جوال، سحابة، IoT، أمن سيبراني — ثمانية تخصصات.',
    ctaWhatsapp: 'واتساب',
