...
const CONTENT = {
  fr: {
    eyebrow:   "Symloop · Cabinet d'ingénierie IA pour industries régulées · Alger · Fondé 2012",
    line1:     'Nous concevons pour',
    rotating:  ['les banques', 'les ministères', 'les opérateurs oil & gas', 'les hôpitaux', 'les groupes pharma', 'les régulateurs'],
    line3:     'au MENA — souverain, on-premise, en production.',
    dek:       "Cabinet d'ingénierie IA-native pour les industries régulées du MENA — banque, gouvernement, oil & gas, santé. Siège à Alger, fondé en 2012, 25+ ingénieurs seniors. Modernisation core banking, plateformes gouvernementales souveraines, IT industriel oil & gas, IA appliquée. Comparable aux cabinets européens (Capgemini Engineering, Sopra Steria), au coût MENA.",
    ctaWhatsapp: 'WhatsApp',
    ctaServices: 'Voir nos services',
    ctaEmail:    'contact@symloop.com',
    clutch:      'Clutch 5.0 / 5.0',
    disciplines: '25+ ingénieurs',
    hq:          'Siège Alger · Fondé 2012',
    regions:     ['MENA', 'Golfe', 'Europe', 'Afrique'],
  },
  en: {
    eyebrow:   'Symloop · AI Engineering Firm for MENA Regulated Industries · Algiers · Founded 2012',
    line1:     'We engineer for',
    rotating:  ['banks', 'ministries', 'oil & gas operators', 'hospitals', 'pharma groups', 'regulators'],
    line3:     'across MENA — sovereign, on-premise, production-grade.',
    dek:       "AI-native engineering firm for MENA's regulated industries — banking, government, oil & gas, healthcare. Headquartered in Algiers, founded 2012, 25+ senior engineers. Core banking modernization, sovereign government platforms, oil & gas IT, applied AI. Comparable in capability to mid-tier European firms (Capgemini Engineering, Sopra Steria), at MENA cost basis.",
    ctaWhatsapp: 'WhatsApp',
    ctaServices: 'See our services',
    ctaEmail:    'contact@symloop.com',
    clutch:      'Clutch 5.0 / 5.0',
    disciplines: '25+ engineers',
    hq:          'Algiers HQ · Founded 2012',
    regions:     ['MENA', 'Gulf', 'Europe', 'Africa'],
  },
  ar: {
    eyebrow:   'سيملوب · شركة هندسة الذكاء الاصطناعي للقطاعات المنظمة · الجزائر العاصمة · تأسست 2012',
    line1:     'نهندس من أجل',
    rotating:  ['المصارف', 'الوزارات', 'مشغلي النفط والغاز', 'المستشفيات', 'مجموعات الأدوية', 'الهيئات التنظيمية'],
    line3:     'في الشرق الأوسط وشمال أفريقيا — سيادي، on-premise، جاهز للإنتاج.',
    dek:       'شركة هندسة ذكاء اصطناعي للقطاعات المنظمة في الشرق الأوسط وشمال أفريقيا — المصارف، الحكومة، النفط والغاز، الصحة. المقر الجزائر العاصمة، تأسست 2012، أكثر من 25 مهندساً. تحديث الأنظمة المصرفية الأساسية، منصات حكومية سيادية، IT صناعي. قابلة للمقارنة مع Capgemini Engineering و Sopra Steria، بتكلفة المنطقة.',
    ctaWhatsapp: 'واتساب',
    ctaServices: 'عرض خدماتنا',
    ctaEmail:    'contact@symloop.com',
    clutch:      'Clutch 5.0 / 5.0',
    disciplines: '25+ مهندسًا',
    hq:          'مقر الجزائر · تأسست 2012',
    regions:     ['الشرق الأوسط وشمال أفريقيا', 'الخليج', 'أوروبا', 'أفريقيا'],
  },
};
