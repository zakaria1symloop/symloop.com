...
const CONTENT = {
  fr: {
    ...
    rotating:  ['ERP sur mesure', 'systèmes IA', 'apps mobiles', 'plateformes IoT', 'infrastructures cloud', 'solutions cybersécurité'],
  ...
  en: {
    ...
    line1:     'We build',
    rotating:  ['custom ERPs', 'AI systems', 'mobile apps', 'IoT platforms', 'cloud infrastructure', 'cybersecurity solutions'],
  ...
  ar: {
    ...
    line1:     'نبني',
    rotating:  ['أنظمة ERP مخصصة', 'أنظمة ذكاء اصطناعي', 'تطبيقات جوال', 'منصات IoT', 'بنى تحتية سحابية', 'حلول أمن سيبراني'],
    line3:     'للإنتاج.',
