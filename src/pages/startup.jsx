...
export default function StartupPage(){const{locale}=useRouter();const isRtl=locale==='ar';const c=C[locale]||C.fr;
  ...
  return(<><SEO title={`${c.title} — Symloop`} description={c.dek} keywords="MVP development startup, best app developers for startups, fintech software development, startup app development, find app developer for startup, mvp development africa, saas startup algeria, startup algérie, label startup algérie, développement mvp, accompagnement startup, product engineering startup, شركة ناشئة الجزائر, تطوير MVP, symloop startup" type="website" structuredData={ld} breadcrumbs={bc} image="/images/cover-startup.jpg"/>
