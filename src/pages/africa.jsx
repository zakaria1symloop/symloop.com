...
export default function AfricaPage(){const{locale}=useRouter();const isRtl=locale==='ar';const c=C[locale]||C.fr;
  ...
  return(<><SEO title={`${c.title} — Symloop`} description={c.dek} keywords="software development africa, engineering firm africa, software company africa, outsourcing africa, nearshore africa, fintech africa, ai africa, startup africa, développement logiciel afrique, ingénierie afrique, outsourcing afrique francophone, fintech afrique, شركة هندسة أفريقيا, تطوير برمجيات أفريقيا, symloop africa" type="website" structuredData={ld} breadcrumbs={bc} image="/images/cover-africa.jpg"/>
