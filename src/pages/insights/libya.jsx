...
// Infrastructure Board (HIB). Verticals as proof: BMS buildings,
...
const CONTENT = {
  en: {
    ...
    dekSeo:      'For NOC, LIA, Corinthia, Al Waddan, Rixos, Libya Real Estate Investment Co and the operators rebuilding Tripoli, Benghazi, Misrata: how Symloop ships AI-driven building automation, hotel PMS and smart-home in 9 months — not 36.',
    ...
    chart: {
      ...
      note:       'Composite benchmark — BMS building-management + hotel PMS + ERP engagements delivered for Libyan, Algerian and MENA clients. Source: Symloop production engagements 2024–2026.',
    },
    ...
    sections: [
      ...
      {
        heading: 'Vertical 2 — AI-driven building automation for residential and commercial stock',
        body: [
    ...
    takeaways: {
      ...
      items: [
        'The Libyan rebuild implies $200M+ of software demand across hotel PMS, AI-driven building automation and smart-home over 2026–2030. No local industry of scale to deliver it.',
        ...
        'AI-driven building automation for residential and commercial stock: $30-60K per building, no recurring fees, locally-manufactured IoT hardware, calibrated for Libyan electrical-grid reality.',
    ...
    faq: [
      ...
      { q: 'What hardware does Symloop\'s AI building management platform use?',
    ...
    cta: {
      ...
      title:   'Considering a hotel PMS, BMS building platform or smart-home rollout in Libya? We scope in two weeks and ship in six months.',
  ...
  fr: {
    ...
    dekSeo:      'Pour NOC, LIA, Corinthia, Al Waddan, Rixos, Libya Real Estate Investment Co et les opérateurs qui reconstruisent Tripoli, Benghazi, Misrata : comment Symloop livre BMS, PMS hôtels et smart home en 9 mois — pas 36.',
    ...
    chart: {
      ...
      note:       'Benchmark composite — missions BMS bâtiment + PMS hôtels + ERP livrées pour clients libyens, algériens et MENA. Source : engagements Symloop 2024–2026.',
    },
    ...
    sections: [
      ...
      {
        heading: 'Vertical 2 — BMS gestion bâtiment pour parc résidentiel et commercial',
        body: [
    ...
    takeaways: {
      ...
      items: [
        'La reconstruction libyenne implique 200M$+ de demande logicielle sur PMS hôtels, BMS et smart home sur 2026-2030. Aucune industrie locale d\'échelle pour le livrer.',
        ...
        'BMS gestion bâtiment pour parc résidentiel et commercial : 30-60K$ par bâtiment, pas de frais récurrents, hardware IoT fabriqué localement, calibré pour la réalité du réseau électrique libyen.',
    ...
    faq: [
      ...
      { q: 'Quel hardware utilise la plateforme IA gestion bâtiment de Symloop ?',
    ...
    cta: {
      ...
      title:   'Vous envisagez un PMS hôtelier, une plateforme IA gestion bâtiment ou un déploiement smart home en Libye ? Nous cadrons en deux semaines et livrons en six mois.',
  ...
  ar: {
    ...
    dekSeo:      'لشركة NOC و LIA و Corinthia و Al Waddan و Rixos والمشغلين الذين يعيدون إعمار طرابلس وبنغازي ومصراتة: كيف يشحن Symloop إدارة المباني BMS و PMS الفنادق والمنزل الذكي في 9 أشهر — لا 36.',
    ...
    chart: {
      ...
      note:       'مقياس مركب — مهام BMS المباني + PMS الفنادق + ERP تم تسليمها لعملاء ليبيين وجزائريين وفي المنطقة. المصدر: مهام Symloop 2024–2026.',
    },
    ...
    sections: [
      {
        ...
        body: [
          ...
          'إدارة المباني أكبر. **خط أنابيب الإسكان السكني والتجاري لهيئة الإسكان والبنية التحتية يعني آلاف المباني الجديدة على العقد القادم، كل واحد منها يحتاج إدارة طاقة (استقرار الكهرباء هو المشكلة التشغيلية في ليبيا، ليس ترفاً) وإدارة مياه وأمن وتحسين تكييف، وبشكل متزايد تتبع الكربون للأهلية للتمويل الدولي**. منصات BMS الأوروبية (Schneider EcoStruxure، Honeywell Forge، Siemens Desigo) تكلف 80-150 ألف دولار لكل مبنى وتتطلب عقود صيانة متكررة بـ 30 ألف دولار سنوياً. Symloop يبني منصة BMS سيادية مكافئة — منشورة في الموقع أو في سحابة محلية منظمة، كود مصدر يملكه العميل الليبي — مقابل 30-60 ألف دولار لكل مبنى بدون رسوم متكررة.',
      ...
      {
        heading: 'القطاع 2 — BMS لإدارة المباني السكنية والتجارية',
        body: [
          ...
          '**منصة BMS السيادية من Symloop** تتكامل مع مستشعرات IoT مثبتة محلياً، تدعم سلوك الشبكة الكهربائية الليبية الفعلي، توفر واجهة ويب وموبايل فرنسية + عربية. **تكلفة النشر لكل مبنى: 30-60 ألف دولار. صيانة سنوية: 5-10 آلاف دولار. لا قفل من البائع.**',
        ],
      },
      {
    ...
    takeaways: {
      ...
      items: [
        'إعادة الإعمار الليبية تعني 200+ مليون دولار من الطلب على البرمجيات عبر PMS الفنادق و BMS والمنزل الذكي بين 2026-2030.',
        ...
        'BMS لإدارة المباني: 30-60 ألف دولار لكل مبنى، لا رسوم متكررة، هاردوير IoT مصنّع محلياً.',
    ...
    faq: [
      ...
      { q: 'ما هو الهاردوير الذي تستخدمه منصة BMS من Symloop؟',
    ...
    cta: {
      ...
      title:   'تفكر في PMS فندقي، منصة BMS أو نشر منزل ذكي في ليبيا؟ نحدّد النطاق في أسبوعين ونشحن في ستة أشهر.',
...
const SCHEMA_ABOUT = [
  ...
  { '@type': 'Thing',        name: 'Building management BMS Libya' },
...
const KEYWORDS = "logiciel libye, ingénierie logicielle libye, AI Libya, software development Libya, hotel PMS Tripoli, hotel software Benghazi, BMS Libya, building management Libya, smart home Tripoli, domotique Libye, reconstruction Libya software, Corinthia software, Al Waddan PMS, Rixos software, NOC software partner, Libya Investment Authority technology, GECOL energy management software, Housing Infrastructure Board software, Libya Real Estate Investment Company software, Libyan rebuild software, North Africa software partner, sovereign software Libya, AI Libya hospitality, AI Libya buildings, Tripoli smart home, Benghazi smart home, Misrata smart home, Libya hotel automation, Libya residential automation, Libya energy management, Libya building automation, Symloop Libya, partenaire ingénierie Libye, PMS hôtel Libye, gestion bâtiment Libye, maison intelligente Libye, automatisation résidentielle Libye, Algérie ingénierie pour Libye, B2B software Africa, African B2B AI partner, logiciel B2B Afrique francophone, Maghreb software vendor, Sahel software partner, West Africa enterprise software, francophone Africa AI consulting, Afrique du Nord-Ouest software, African digital transformation B2B, Africa enterprise software partner, MENA Africa software, software partner for African enterprises, African industries AI, AfDB software vendor, regional bank software Africa, pan-African software";

// Locale-aware chart payload. The OpportunityStackChart visualizes the
// total Libyan reconstruction software opportunity as a horizontal
// stacked bar broken down by vertical — gives the page a distinct
// visual identity vs. the side-by-side comparison charts on other
// country briefs.
const CHART_DATA = {
  fr: {
    label:      'Opportunité logicielle reconstruction libyenne · 2026-2030',
    totalLabel: 'Total addressable · PMS + bâtiment + smart home',
    totalValue: '$200M+',
    segments: [
      { label: 'Gestion bâtiment + BMS', shortLabel: 'BMS $100M', value: 100, formattedValue: '$80-120M', sub: 'Pipeline HIB résidentiel + commercial. Schneider/Honeywell européens à 3x le coût.' },
      { label: 'PMS hôtelier',           shortLabel: 'PMS $50M',  value: 50,  formattedValue: '$40-60M',  sub: 'Corinthia, Al Waddan, Rixos Tripoli + nouvelles constructions Marriott/Hilton.' },
      { label: 'Smart home résidentiel', shortLabel: 'Home $70M', value: 70,  formattedValue: '$60-80M',  sub: 'Tripoli luxe + Misrata seafront + communautés diaspora.' },
    ],
    note: 'Estimation composite — opportunité logicielle agrégée sur PMS hôtels, plateformes BMS et smart home pour la reconstruction libyenne 2026-2030. Source : missions Symloop + recherche secteur 2024-2026.',
  },
  en: {
    label:      'Libyan rebuild software opportunity · 2026-2030',
    totalLabel: 'Total addressable · PMS + buildings + smart home',
    totalValue: '$200M+',
    segments: [
      { label: 'Building management + BMS', shortLabel: 'BMS $100M', value: 100, formattedValue: '$80-120M', sub: 'HIB residential + commercial pipeline. Schneider/Honeywell European vendors at 3x cost.' },
      { label: 'Hotel PMS',                 shortLabel: 'PMS $50M',  value: 50,  formattedValue: '$40-60M',  sub: 'Corinthia, Al Waddan, Rixos Tripoli + new Marriott/Hilton builds.' },
      { label: 'Residential smart home',    shortLabel: 'Home $70M', value: 70,  formattedValue: '$60-80M',  sub: 'Tripoli luxury + Misrata seafront + diaspora gated communities.' },
    ],
    note: 'Composite estimate — aggregate software opportunity across hotel PMS, BMS platforms and smart home for the Libyan rebuild 2026-2030. Source: Symloop engagements + sector research 2024-2026.',
  },
  ar: {
    label:      'فرصة برمجيات إعادة الإعمار الليبية · 2026-2030',
    totalLabel: 'الإجمالي القابل للعنونة · PMS + المباني + المنزل الذكي',
    totalValue: '$200M+',
    segments: [
      { label: 'إدارة المباني + BMS',  shortLabel: 'BMS $100M', value: 100, formattedValue: '$80-120M', sub: 'خط أنابيب HIB السكني + التجاري. البائعون الأوروبيون بثلاث أضعاف التكلفة.' },
      { label: 'PMS الفنادق',           shortLabel: 'PMS $50M',  value: 50,  formattedValue: '$40-60M',  sub: 'Corinthia و Al Waddan و Rixos طرابلس + بناءات Marriott/Hilton جديدة.' },
      { label: 'المنزل الذكي السكني', shortLabel: 'Home $70M', value: 70,  formattedValue: '$60-80M',  sub: 'فخامة طرابلس + واجهة مصراتة البحرية + مجتمعات الشتات.' },
    ],
